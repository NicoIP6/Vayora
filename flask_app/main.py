...
def create_app():
    ...
    def home():
        ...
        forecasts = Weatherforecast.query.with_entities(
            ...
            Weatherforecast.relative_humidity_2m,
            Weatherforecast.precipitation,
            Weatherforecast.pressure_msl,
            Weatherforecast.surface_pressure,
            Weatherforecast.cloud_cover_high,
            Weatherforecast.wind_speed_180m,
            Weatherforecast.wind_direction_180m,
            Weatherforecast.temperature_180m
        ).filter(
